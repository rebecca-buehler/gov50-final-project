...
In my final visualization, I plan to superimpose a graph of fatalities from events that targeted women specifically over this graph of all civilian fatalities. I have not been able to do this yet because I needed to create a new variable in the dataset for events that targeted women. I am waiting to hear back from the Ethiopian Peace Observatory about their codebook before making this variable.
